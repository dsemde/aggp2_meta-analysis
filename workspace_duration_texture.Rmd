...
```{r}
tempirrig1 <- split(short, short$soil_texture=="coarse")
shortd <- tempirrig1$'TRUE'

tempirrig2 <- split(medium, medium$soil_texture=="coarse")
mediumd <- tempirrig2$'TRUE'

tempirrig3 <- split(long, long$soil_texture=="coarse")
...
```{r}
tempirrig1 <- split(short, short$soil_texture=="medium")
shorts <- tempirrig1$'TRUE'

tempirrig2 <- split(medium, medium$soil_texture=="medium")
mediums <- tempirrig2$'TRUE'

tempirrig3 <- split(long, long$soil_texture=="medium")
...
```{r}
tempirrig1 <- split(short, short$soil_texture=="fine")
shortf <- tempirrig1$'TRUE'

tempirrig2 <- split(medium, medium$soil_texture=="fine")
mediumf <- tempirrig2$'TRUE'

tempirrig3 <- split(long, long$soil_texture=="fine")
