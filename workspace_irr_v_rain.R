...
# Load dataset
datacsv <- read_csv("datasets/irrvrain_estBD.csv")
...
# Arid
mean <- check_NaN(w.mean(arid$per_OC_st_change,arid$organic_C_n_rainfed))
se <- check_se(w.sd(arid$per_OC_st_change,arid$organic_C_n_rainfed)/sqrt(sum(arid$organic_C_n_rainfed)))
low <- mean-se
high <- mean+se
obs <- sum(arid$organic_C_n_rainfed)
n_study <- length(arid$organic_C_n_rainfed)
output <- c("23", "Aridity", "Arid", "0 - 10 cm", mean, se, low, high, "orange", obs, n_study)
#output <- c("14", "Aridity", "Arid", "0 - 10 cm", mean, "orange", n_study)

# Semi-arid
mean <- check_NaN(w.mean(semi$per_OC_st_change,semi$organic_C_n_rainfed))
se <- check_se(w.sd(semi$per_OC_st_change,semi$organic_C_n_rainfed)/sqrt(sum(semi$organic_C_n_rainfed)))
low <- mean-se
high <- mean+se
obs <- sum(semi$organic_C_n_rainfed)
n_study <- length(semi$organic_C_n_rainfed)
...
# Dry sub-humid
mean <- check_NaN(w.mean(subhumid$per_OC_st_change,subhumid$organic_C_n_rainfed))
se <- check_se(w.sd(subhumid$per_OC_st_change,subhumid$organic_C_n_rainfed)/sqrt(sum(subhumid$organic_C_n_rainfed)))
low <- mean-se
high <- mean+se
obs <- sum(subhumid$organic_C_n_rainfed)
n_study <- length(subhumid$organic_C_n_rainfed)
...
# Humid
mean <- check_NaN(w.mean(humid$per_OC_st_change,humid$organic_C_n_rainfed))
se <- check_se(w.sd(humid$per_OC_st_change,humid$organic_C_n_rainfed)/sqrt(sum(humid$organic_C_n_rainfed)))
low <- mean-se
high <- mean+se
obs <- sum(humid$organic_C_n_rainfed)
n_study <- length(humid$organic_C_n_rainfed)
...
# 
# # Coarse
# mean <- check_NaN(w.mean(coarse$per_OC_st_change,coarse$organic_C_n_rainfed))
# se <- check_se(w.sd(coarse$per_OC_st_change,coarse$organic_C_n_rainfed)/sqrt(sum(coarse$organic_C_n_rainfed)))
# low <- mean-se
# high <- mean+se
# obs <- sum(coarse$organic_C_n_rainfed)
# n_study <- length(coarse$organic_C_n_rainfed)
# add_row <- c("9", "Texture", "Coarse", "0 - 10 cm", mean, se, low, high, "#bf63bf", obs, n_study)
# output <- rbind(output, add_row)
# 
# # Medium
# mean <- check_NaN(w.mean(medium$per_OC_st_change,medium$organic_C_n_rainfed))
# se <- check_se(w.sd(medium$per_OC_st_change,medium$organic_C_n_rainfed)/sqrt(sum(medium$organic_C_n_rainfed)))
# low <- mean-se
# high <- mean+se
# obs <- sum(medium$organic_C_n_rainfed)
# n_study <- length(medium$organic_C_n_rainfed)
# add_row <- c("8", "Texture", "Medium", "0 - 10 cm", mean, se, low, high, "#bf63bf", obs, n_study)
# output <- rbind(output, add_row)
# 
# # Fine
# mean <- check_NaN(w.mean(fine$per_OC_st_change,fine$organic_C_n_rainfed))
# se <- check_se(w.sd(fine$per_OC_st_change,fine$organic_C_n_rainfed)/sqrt(sum(fine$organic_C_n_rainfed)))
# low <- mean-se
# high <- mean+se
# obs <- sum(fine$organic_C_n_rainfed)
# n_study <- length(fine$organic_C_n_rainfed)
...
# 
# # Drip
# mean <- check_NaN(w.mean(drip$per_OC_st_change,drip$organic_C_n_rainfed))
# se <- check_se(w.sd(drip$per_OC_st_change,drip$organic_C_n_rainfed)/sqrt(sum(drip$organic_C_n_rainfed)))
# low <- mean-se
# high <- mean+se
# obs <- sum(drip$organic_C_n_rainfed)
# n_study <- length(drip$organic_C_n_rainfed)
# add_row <- c("5", "Irrigation", "Drip", "0 - 10 cm", mean, se, low, high, "cadetblue", obs, n_study)
# output <- rbind(output, add_row)
# 
# # Sprinler
# mean <- check_NaN(w.mean(sprinkler$per_OC_st_change,sprinkler$organic_C_n_rainfed))
# se <- check_se(w.sd(sprinkler$per_OC_st_change,sprinkler$organic_C_n_rainfed)/sqrt(sum(sprinkler$organic_C_n_rainfed)))
# low <- mean-se
# high <- mean+se
# obs <- sum(sprinkler$organic_C_n_rainfed)
# n_study <- length(sprinkler$organic_C_n_rainfed)
# add_row <- c("4", "Irrigation", "Sprinkler", "0 - 10 cm", mean, se, low, high, "cadetblue", obs, n_study)
# output <- rbind(output, add_row)
# 
# # Flood/Furrow
# mean <- check_NaN(w.mean(flood$per_OC_st_change,flood$organic_C_n_rainfed))
# se <- check_se(w.sd(flood$per_OC_st_change,flood$organic_C_n_rainfed)/sqrt(sum(flood$organic_C_n_rainfed)))
# low <- mean-se
# high <- mean+se
# obs <- sum(flood$organic_C_n_rainfed)
# n_study <- length(flood$organic_C_n_rainfed)
...
# All 0 - 10 cm
mean <- check_NaN(w.mean(dataset_10$per_OC_st_change,dataset_10$organic_C_n_rainfed))
se <- check_se(w.sd(dataset_10$per_OC_st_change,dataset_10$organic_C_n_rainfed)/sqrt(sum(dataset_10$organic_C_n_rainfed)))
low <- mean-se
high <- mean+se
obs <- sum(dataset_10$organic_C_n_rainfed)
n_study <- length(dataset_10$organic_C_n_rainfed)
...
# All 10 - 20 cm
mean <- check_NaN(w.mean(dataset_20$per_OC_st_change,dataset_20$organic_C_n_rainfed))
se <- check_se(w.sd(dataset_20$per_OC_st_change,dataset_20$organic_C_n_rainfed)/sqrt(sum(dataset_20$organic_C_n_rainfed)))
low <- mean-se
high <- mean+se
obs <- sum(dataset_20$organic_C_n_rainfed)
n_study <- length(dataset_20$organic_C_n_rainfed)
...
# All 20 - 30 cm
mean <- check_NaN(w.mean(dataset_30$per_OC_st_change,dataset_30$organic_C_n_rainfed))
se <- check_se(w.sd(dataset_30$per_OC_st_change,dataset_30$organic_C_n_rainfed)/sqrt(sum(dataset_30$organic_C_n_rainfed)))
low <- mean-se
high <- mean+se
obs <- sum(dataset_30$organic_C_n_rainfed)
n_study <- length(dataset_30$organic_C_n_rainfed)
...
# All 20 - 30 cm
mean <- check_NaN(w.mean(dataset_30p$per_OC_st_change,dataset_30p$organic_C_n_rainfed))
se <- check_se(w.sd(dataset_30p$per_OC_st_change,dataset_30p$organic_C_n_rainfed)/sqrt(sum(dataset_30p$organic_C_n_rainfed)))
low <- mean-se
high <- mean+se
obs <- sum(dataset_30p$organic_C_n_rainfed)
n_study <- length(dataset_30p$organic_C_n_rainfed)
...
# mean <- check_NaN(w.mean(dataset$per_OC_st_change,dataset$organic_C_n_rainfed))
# se <- check_se(w.sd(dataset$per_OC_st_change,dataset$organic_C_n_rainfed)/sqrt(sum(dataset$organic_C_n_rainfed)))
# low <- mean-se
# high <- mean+se
# obs <- sum(dataset$organic_C_n_rainfed)
# n_study <- length(dataset$organic_C_n_rainfed)
...
write_csv(output, "datasets/irr_v_rain_aridity_texture_irrigation_depth.csv")
