---
title: "Aridity Category by Percent OC Change"
output:
  html_document:
    df_print: paged
---

Look for potential differences in the change in OC by aridity category.
...
```{r}
# Boxplot to visualize the average percent change for each aridity category
p <- ggboxplot(depth_10, x="aridity_category", y="per_OC_change", 
          #color = "depth_cat_2", palette = c("#00AFBB", "#E7B800", "#71f442", "#fc79e6"),
          order = c("Hyper Arid", "Arid", "Semi-Arid", "Dry sub-humid", "Humid"),
          ylab = "Organic Carbon Change from T1 to T2 (%)", xlab = "Aridity Category")
p + theme(axis.text.x = element_text(angle = 60, hjust = 1))
```

```{r}
# ANOVA and Tukey's for above boxplot
aov_0_10_per_C <- aov(per_OC_change ~ aridity_category, data = depth_10)
...
```{r}
# Boxplot to visualize the average percent change for each aridity category
p2 <- ggboxplot(depth_20, x="aridity_category", y="per_OC_change", 
          #color = "depth_cat_2", palette = c("#00AFBB", "#E7B800", "#71f442", "#fc79e6"),
          order = c("Hyper Arid", "Arid", "Semi-Arid", "Dry sub-humid", "Humid"),
          ylab = "Organic Carbon Change from T1 to T2 (%)", xlab = "Aridity Category")
...
```{r}
# ANOVA and Tukey's for above boxplot
aov_10_20_per_C <- aov(per_OC_change ~ aridity_category, data = depth_20)
...
```{r}
# Boxplot to visualize the average percent change for each aridity category
p3 <- ggboxplot(depth_30, x="aridity_category", y="per_OC_change", 
          #color = "depth_cat_2", palette = c("#00AFBB", "#E7B800", "#71f442", "#fc79e6"),
          order = c("Hyper Arid", "Arid", "Semi-Arid", "Dry sub-humid", "Humid"),
          ylab = "Organic Carbon Change from T1 to T2 (%)", xlab = "Aridity Category")
...
```{r}
# ANOVA and Tukey's for above boxplot
aov_20_30_per_C <- aov(per_OC_change ~ aridity_category, data = depth_30)
...
```{r}
# Boxplot to visualize the average percent change for each aridity category
p4 <- ggboxplot(depth_30p, x="aridity_category", y="per_OC_change", 
          #color = "depth_cat_2", palette = c("#00AFBB", "#E7B800", "#71f442", "#fc79e6"),
          order = c("Hyper Arid", "Arid", "Semi-Arid", "Dry sub-humid", "Humid"),
          ylab = "Organic Carbon Change from T1 to T2 (%)", xlab = "Aridity Category")
...
```{r}
# ANOVA and Tukey's for above boxplot
aov_30p_per_C <- aov(per_OC_change ~ aridity_category, data = depth_30p)
...
```{r}
# Boxplot to visualize the average percent change for each aridity category
p5 <- ggboxplot(dataset, x="aridity_category", y="per_OC_change", 
          color = "depth_cat_2", palette = c("#00AFBB", "#E7B800", "#71f442", "#fc79e6"),
          order = c("Hyper Arid", "Arid", "Semi-Arid", "Dry sub-humid", "Humid"),
          ylab = "Organic Carbon Change from T1 to T2 (%)", xlab = "Aridity Category")
