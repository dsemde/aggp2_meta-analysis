...
tiff("OC Stock Semi-arid 0 to 10 by Duration june 23.tiff", width = 4, height = 3.5, units = 'in', res = 300)
...
mtext("Semi-arid Climate", side=2, line = 3.5, cex=0.75, adj=0.95)
mtext("Sprinkler Irrigation", side=2, line = 3.5, cex=0.75, adj=0.05)
