...
text(ifelse(drip$High_Perc > 85, drip$Low_Perc-7, drip$High_Perc+5), drip$ID
     , paste(drip$n_study), cex=0.85, adj=0)
...
text(ifelse(sprinkler$High_Perc > 85, sprinkler$Low_Perc-7, sprinkler$High_Perc+9), sprinkler$ID
     , paste(sprinkler$n_study), cex=0.85, adj=0)
...
text(ifelse(floodfurr$High_Perc > 85, floodfurr$Low_Perc-7, floodfurr$High_Perc+7), floodfurr$ID
     , paste(floodfurr$n_study), cex=0.85, adj=0)
