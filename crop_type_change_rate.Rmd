---
title: "Crop Type by OC Change Rate"
output:
  html_document:
    df_print: paged
---

Look for potential differences in OC change rate by crop type category.
...
```{r}
# Boxplot to visualize the average rate of change for each crop type category
p <- ggboxplot(depth_10, x="crop_type", y="OC_change_rate", 
          #color = "depth_cat_2", palette = c("#00AFBB", "#E7B800", "#71f442", "#fc79e6"),
          ylab = "Organic Carbon Change Rate (OC conc./yr)", xlab = "Crop Type")
p + theme(axis.text.x = element_text(angle = 60, hjust = 1))
```


```{r}
aov_0_10_per_C <- aov(OC_change_rate ~ crop_type, data = depth_10)
...
```{r}
# Boxplot to visualize the average rate of change for each crop type category
p2 <- ggboxplot(depth_20, x="crop_type", y="OC_change_rate", 
          #color = "depth_cat_2", palette = c("#00AFBB", "#E7B800", "#71f442", "#fc79e6"),
          ylab = "Organic Carbon Change Rate (OC conc./yr)", xlab = "Crop Type")
...
```{r}
aov_10_20_per_C <- aov(OC_change_rate ~ crop_type, data = depth_20)
...
```{r}
# Boxplot to visualize the average rate of change for each crop type category
p3 <- ggboxplot(depth_30, x="crop_type", y="OC_change_rate", 
          #color = "depth_cat_2", palette = c("#00AFBB", "#E7B800", "#71f442", "#fc79e6"),
          ylab = "Organic Carbon Change Rate (OC conc./yr)", xlab = "Crop Type")
...
```{r}
aov_20_30_per_C <- aov(OC_change_rate ~ crop_type, data = depth_30)
...
```{r}
# Boxplot to visualize the average rate of change for each crop type category
p4 <- ggboxplot(depth_30p, x="crop_type", y="OC_change_rate", 
          #color = "depth_cat_2", palette = c("#00AFBB", "#E7B800", "#71f442", "#fc79e6"),
          ylab = "Organic Carbon Change Rate (OC conc./yr)", xlab = "Crop Type")
...
```{r}
aov_30p_per_C <- aov(OC_change_rate ~ crop_type, data = depth_30p)
...
```{r}
# Boxplot to visualize the average rate of change for each crop type category
p5 <- ggboxplot(dataset, x="crop_type", y="OC_change_rate", 
          color = "depth_cat_2", palette = c("#00AFBB", "#E7B800", "#71f442", "#fc79e6"),
          ylab = "Organic Carbon Change Rate (OC conc./yr)", xlab = "Crop Type")
