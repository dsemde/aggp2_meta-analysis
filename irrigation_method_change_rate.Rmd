---
title: "Irrigation Method by the Rate of Organic Carbon Change"
output:
  html_document:
    df_print: paged
---

Look for potential differences in rate of OC change by irrigation method.
...
```{r}
# Boxplot to visualize the average OC change rate for each Irrigation Method (Category)
p <- ggboxplot(depth_10, x="irrig_methodcat", y="OC_change_rate", 
          #color = "depth_cat_2", palette = c("#00AFBB", "#E7B800", "#71f442", "#fc79e6"),
          ylab = "Organic Carbon Change Rate (OC conc./yr)", xlab = "Irrigation Method")
p + theme(axis.text.x = element_text(angle = 60, hjust = 1))
```

```{r}
# ANOVA and Tukey's for above boxplot
aov_0_10_per_C <- aov(OC_change_rate ~ irrig_methodcat, data = depth_10)
...
```{r}
# Boxplot to visualize the average OC change rate for each Irrigation Method (Category)
p2 <- ggboxplot(depth_20, x="irrig_methodcat", y="OC_change_rate", 
          #color = "depth_cat_2", palette = c("#00AFBB", "#E7B800", "#71f442", "#fc79e6"),
          ylab = "Organic Carbon Change Rate (OC conc./yr)", xlab = "Irrigation Method")
...
```{r}
# ANOVA and Tukey's for above boxplot
aov_10_20_per_C <- aov(OC_change_rate ~ irrig_methodcat, data = depth_20)
...
```{r}
# Boxplot to visualize the average OC change rate for each Irrigation Method (Category)
p3 <- ggboxplot(depth_30, x="irrig_methodcat", y="OC_change_rate", 
          #color = "depth_cat_2", palette = c("#00AFBB", "#E7B800", "#71f442", "#fc79e6"),
          ylab = "Organic Carbon Change Rate (OC conc./yr)", xlab = "Irrigation Method")
...
```{r}
# ANOVA and Tukey's for above boxplot
aov_20_30_per_C <- aov(OC_change_rate ~ irrig_methodcat, data = depth_30)
...
```{r}
# Boxplot to visualize the average OC change rate for each Irrigation Method (Category)
p4 <- ggboxplot(depth_30p, x="irrig_methodcat", y="OC_change_rate", 
          #color = "depth_cat_2", palette = c("#00AFBB", "#E7B800", "#71f442", "#fc79e6"),
          ylab = "Organic Carbon Change Rate (OC conc./yr)", xlab = "Irrigation Method")
...
```{r}
# ANOVA and Tukey's for above boxplot
aov_30p_per_C <- aov(OC_change_rate ~ irrig_methodcat, data = depth_30p)
...
## Change Rate by Crop Type and Depth

```{r}
# Boxplot to visualize the average OC change rate for each Irrigation Method (Category) and depth
p5 <- ggboxplot(dataset, x="irrig_methodcat", y="OC_change_rate", 
          color = "depth_cat_2", palette = c("#00AFBB", "#E7B800", "#71f442", "#fc79e6"),
          ylab = "Organic Carbon Change Rate (OC conc./yr)", xlab = "Irrigation Method")
