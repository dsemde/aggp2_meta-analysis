...
tiff("Figure x - Water Source by Depth.tiff", width = 4, height = 9, units = 'in', res = 300)
...
axis (side = 1, at = seq(-15, 90, 5), labels = seq(-15, 90, 5)
      , cex=0.75
      , las = 1)
...
# Separation lines
abline(h=c(5, 10, 15), col="black", lty=3, lwd=2)
