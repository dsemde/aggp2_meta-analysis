...
output <- c("14", "Drip", "0-10 cm", "short", mean, se, low, high, "cadetblue", obs, n_study)
...
add_row <- c("13", "Drip", "10-20 cm", "short", mean, se, low, high, "cadetblue", obs, n_study)
...
add_row <- c("12", "Drip", "20-30 cm", "short", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
add_row <- c("11", "Drip", "30+ cm", "short", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
add_row <- c("9", "Drip", "0-10 cm", "medium", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
add_row <- c("8", "Drip", "10-20 cm", "medium", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
add_row <- c("7", "Drip", "20-30 cm", "medium", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
add_row <- c("6", "Drip", "30+ cm", "medium", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
add_row <- c("4", "Drip", "0-10 cm", "long", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
add_row <- c("3", "Drip", "10-20 cm", "long", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
add_row <- c("2", "Drip", "20-30 cm", "long", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
add_row <- c("1", "Drip", "30+ cm", "long", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(short10$organic_C_n_t1)
n_study <- length(short10$organic_C_n_t1)
add_row <- c("14", "Sprinkler", "0-10 cm", "short", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(short20$organic_C_n_t1)
n_study <- length(short20$organic_C_n_t1)
add_row <- c("13", "Sprinkler", "10-20 cm", "short", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(short30$organic_C_n_t1)
n_study <- length(short30$organic_C_n_t1)
add_row <- c("12", "Sprinkler", "20-30 cm", "short", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(short30p$organic_C_n_t1)
n_study <- length(short30p$organic_C_n_t1)
add_row <- c("11", "Sprinkler", "30+ cm", "short", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(medium10$organic_C_n_t1)
n_study <- length(medium10$organic_C_n_t1)
add_row <- c("9", "Sprinkler", "0-10 cm", "medium", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(medium20$organic_C_n_t1)
n_study <- length(medium20$organic_C_n_t1)
add_row <- c("8", "Sprinkler", "10-20 cm", "medium", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(medium30$organic_C_n_t1)
n_study <- length(medium30$organic_C_n_t1)
add_row <- c("7", "Sprinkler", "20-30 cm", "medium", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(medium30p$organic_C_n_t1)
n_study <- length(medium30p$organic_C_n_t1)
add_row <- c("6", "Sprinkler", "30+ cm", "medium", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(long10$organic_C_n_t1)
n_study <- length(long10$organic_C_n_t1)
add_row <- c("4", "Sprinkler", "0-10 cm", "long", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(long20$organic_C_n_t1)
n_study <- length(long20$organic_C_n_t1)
add_row <- c("3", "Sprinkler", "10-20 cm", "long", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(long30$organic_C_n_t1)
n_study <- length(long30$organic_C_n_t1)
add_row <- c("2", "Sprinkler", "20-30 cm", "long", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(long30p$organic_C_n_t1)
n_study <- length(long30p$organic_C_n_t1)
add_row <- c("1", "Sprinkler", "30+ cm", "long", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(short10$organic_C_n_t1)
n_study <- length(short10$organic_C_n_t1)
add_row <- c("14", "Flood/Furrow", "0-10 cm", "short", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(short20$organic_C_n_t1)
n_study <- length(short20$organic_C_n_t1)
add_row <- c("13", "Flood/Furrow", "10-20 cm", "short", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(short30$organic_C_n_t1)
n_study <- length(short30$organic_C_n_t1)
add_row <- c("12", "Flood/Furrow", "20-30 cm", "short", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(short30p$organic_C_n_t1)
n_study <- length(short30p$organic_C_n_t1)
add_row <- c("11", "Flood/Furrow", "30+ cm", "short", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(medium10$organic_C_n_t1)
n_study <- length(medium10$organic_C_n_t1)
add_row <- c("9", "Flood/Furrow", "0-10 cm", "medium", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(medium20$organic_C_n_t1)
n_study <- length(medium20$organic_C_n_t1)
add_row <- c("8", "Flood/Furrow", "10-20 cm", "medium", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(medium30$organic_C_n_t1)
n_study <- length(medium30$organic_C_n_t1)
add_row <- c("7", "Flood/Furrow", "20-30 cm", "medium", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(medium30p$organic_C_n_t1)
n_study <- length(medium30p$organic_C_n_t1)
add_row <- c("6", "Flood/Furrow", "30+ cm", "medium", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(long10$organic_C_n_t1)
n_study <- length(long10$organic_C_n_t1)
add_row <- c("4", "Flood/Furrow", "0-10 cm", "long", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(long20$organic_C_n_t1)
n_study <- length(long20$organic_C_n_t1)
add_row <- c("3", "Flood/Furrow", "10-20 cm", "long", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(long30$organic_C_n_t1)
n_study <- length(long30$organic_C_n_t1)
add_row <- c("2", "Flood/Furrow", "20-30 cm", "long", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(long30p$organic_C_n_t1)
n_study <- length(long30p$organic_C_n_t1)
add_row <- c("1", "Flood/Furrow", "30+ cm", "long", mean, se, low, high, "cadetblue", obs, n_study)
output <- rbind(output, add_row)
