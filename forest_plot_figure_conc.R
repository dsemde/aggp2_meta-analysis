...
sum_data <- read.csv("datasets/forest_plot_conc_apr20.csv")
...
tiff("OC Meta Conc.tiff", width = 12, height = 4, units = 'in', res = 300)
...
mtext(side = 1, text = paste("Soil carbon concentration (% change)", sep=" "), line = 1, cex=0.75, outer = T, adj = 0.5)
