...
output <- c("17", "Coarse", "0-10 cm", "short", mean, se, low, high, "orange", obs, n_study)
...
add_row <- c("16", "Coarse", "10-20 cm", "short", mean, se, low, high, "orange", obs, n_study)
...
add_row <- c("15", "Coarse", "20-30 cm", "short", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
add_row <- c("14", "Coarse", "30+ cm", "short", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
add_row <- c("11", "Coarse", "0-10 cm", "medium", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
add_row <- c("10", "Coarse", "10-20 cm", "medium", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
add_row <- c("9", "Coarse", "20-30 cm", "medium", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
add_row <- c("8", "Coarse", "30+ cm", "medium", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
add_row <- c("5", "Coarse", "0-10 cm", "long", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
add_row <- c("4", "Coarse", "10-20 cm", "long", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
add_row <- c("3", "Coarse", "20-30 cm", "long", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
add_row <- c("2", "Coarse", "30+ cm", "long", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(short10$organic_C_n_t1)
n_study <- length(short10$organic_C_n_t1)
add_row <- c("17", "Medium", "0-10 cm", "short", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(short20$organic_C_n_t1)
n_study <- length(short20$organic_C_n_t1)
add_row <- c("16", "Medium", "10-20 cm", "short", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(short30$organic_C_n_t1)
n_study <- length(short30$organic_C_n_t1)
add_row <- c("15", "Medium", "20-30 cm", "short", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(short30p$organic_C_n_t1)
n_study <- length(short30p$organic_C_n_t1)
add_row <- c("14", "Medium", "30+ cm", "short", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(medium10$organic_C_n_t1)
n_study <- length(medium10$organic_C_n_t1)
add_row <- c("11", "Medium", "0-10 cm", "medium", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(medium20$organic_C_n_t1)
n_study <- length(medium20$organic_C_n_t1)
add_row <- c("10", "Medium", "10-20 cm", "medium", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(medium30$organic_C_n_t1)
n_study <- length(medium30$organic_C_n_t1)
add_row <- c("9", "Medium", "20-30 cm", "medium", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(medium30p$organic_C_n_t1)
n_study <- length(medium30p$organic_C_n_t1)
add_row <- c("8", "Medium", "30+ cm", "medium", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(long10$organic_C_n_t1)
n_study <- length(long10$organic_C_n_t1)
add_row <- c("5", "Medium", "0-10 cm", "long", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(long20$organic_C_n_t1)
n_study <- length(long20$organic_C_n_t1)
add_row <- c("4", "Medium", "10-20 cm", "long", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(long30$organic_C_n_t1)
n_study <- length(long30$organic_C_n_t1)
add_row <- c("3", "Medium", "20-30 cm", "long", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(long30p$organic_C_n_t1)
n_study <- length(long30p$organic_C_n_t1)
add_row <- c("2", "Medium", "30+ cm", "long", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(short10$organic_C_n_t1)
n_study <- length(short10$organic_C_n_t1)
add_row <- c("17", "Fine", "0-10 cm", "short", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(short20$organic_C_n_t1)
n_study <- length(short20$organic_C_n_t1)
add_row <- c("16", "Fine", "10-20 cm", "short", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(short30$organic_C_n_t1)
n_study <- length(short30$organic_C_n_t1)
add_row <- c("15", "Fine", "20-30 cm", "short", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(short30p$organic_C_n_t1)
n_study <- length(short30p$organic_C_n_t1)
add_row <- c("14", "Fine", "30+ cm", "short", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(medium10$organic_C_n_t1)
n_study <- length(medium10$organic_C_n_t1)
add_row <- c("11", "Fine", "0-10 cm", "medium", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(medium20$organic_C_n_t1)
n_study <- length(medium20$organic_C_n_t1)
add_row <- c("10", "Fine", "10-20 cm", "medium", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(medium30$organic_C_n_t1)
n_study <- length(medium30$organic_C_n_t1)
add_row <- c("9", "Fine", "20-30 cm", "medium", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(medium30p$organic_C_n_t1)
n_study <- length(medium30p$organic_C_n_t1)
add_row <- c("8", "Fine", "30+ cm", "medium", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(long10$organic_C_n_t1)
n_study <- length(long10$organic_C_n_t1)
add_row <- c("5", "Fine", "0-10 cm", "long", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(long20$organic_C_n_t1)
n_study <- length(long20$organic_C_n_t1)
add_row <- c("4", "Fine", "10-20 cm", "long", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(long30$organic_C_n_t1)
n_study <- length(long30$organic_C_n_t1)
add_row <- c("3", "Fine", "20-30 cm", "long", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(long30p$organic_C_n_t1)
n_study <- length(long30p$organic_C_n_t1)
add_row <- c("2", "Fine", "30+ cm", "long", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
