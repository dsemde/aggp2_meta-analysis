...
tiff("OC Stock Semi-arid 0 to 10 by Duration.tiff", width = 5, height = 6, units = 'in', res = 300)
...
axis (side = 1, at = seq(-40, 60, 10), labels = seq(-40, 60, 10)
      , cex=0.75
      , las = 1)
...
mtext("Semi-arid Climate", side=4, cex=0.75, adj=0.8)
mtext("Sprinkler Irrigation", side=4, cex=0.75, adj=0.2)
