...
datasettemp <- split(dataset, dataset$aridity_category=="Arid")
dataset_arid <- datasettemp$'TRUE'

# Split dataset by Duration
ds <- split(dataset_arid, dataset_arid$study_duration_cat=="short term")
short <- ds$'TRUE'

dm <- split(dataset_arid, dataset_arid$study_duration_cat=="medium term")
medium <- dm$'TRUE'

dl <- split(dataset_arid, dataset_arid$study_duration_cat=="long term")
long <- dl$'TRUE'
...
#tempshort1 <- split(short, short$depth_cat_2=="0-10cm")
#short10 <- tempshort1$'TRUE'

#tempshort2 <- split(short, short$depth_cat_2=="10-20cm")
#short20 <- tempshort2$'TRUE'

#tempshort3 <- split(short, short$depth_cat_2=="20-30cm")
#short30 <- tempshort3$'TRUE'

#tempshort4 <- split(short, short$depth_cat_2=="30+cm")
#short30p <- tempshort4$'TRUE'
...
#tempmedium1 <- split(medium, medium$depth_cat_2=="0-10cm")
#medium10 <- tempmedium1$'TRUE'

#tempmedium2 <- split(medium, medium$depth_cat_2=="10-20cm")
#medium20 <- tempmedium2$'TRUE'

#tempmedium3 <- split(medium, medium$depth_cat_2=="20-30cm")
#medium30 <- tempmedium3$'TRUE'

#tempmedium4 <- split(medium, medium$depth_cat_2=="30+cm")
#medium30p <- tempmedium4$'TRUE'
...
#templong1 <- split(long, long$depth_cat_2=="0-10cm")
#long10 <- templong1$'TRUE'

#templong2 <- split(long, long$depth_cat_2=="10-20cm")
#long20 <- templong2$'TRUE'

#templong3 <- split(long, long$depth_cat_2=="20-30cm")
#long30 <- templong3$'TRUE'

#templong4 <- split(long, long$depth_cat_2=="30+cm")
#long30p <- templong4$'TRUE'
...
dataset_semiarid <- datasettemp$'TRUE'

# Split dataset by Duration
ds <- split(dataset_semiarid, dataset_semiarid$study_duration_cat=="short term")
short <- ds$'TRUE'
dm <- split(dataset_semiarid, dataset_semiarid$study_duration_cat=="medium term")
medium <- dm$'TRUE'
dl <- split(dataset_semiarid, dataset_semiarid$study_duration_cat=="long term")
long <- dl$'TRUE'
...
# Separate out Semi-Arid Sites
datasettemp <- split(dataset, dataset$aridity_category=="Dry sub-humid")
dataset_drysubhumid <- datasettemp$'TRUE'

# Split dataset by Duration
ds <- split(dataset_drysubhumid, dataset_drysubhumid$study_duration_cat=="short term")
short <- ds$'TRUE'
dm <- split(dataset_drysubhumid, dataset_drysubhumid$study_duration_cat=="medium term")
medium <- dm$'TRUE'
dl <- split(dataset_drysubhumid, dataset_drysubhumid$study_duration_cat=="long term")
long <- dl$'TRUE'
...
# Separate out Semi-Arid Sites
datasettemp <- split(dataset, dataset$aridity_category=="Humid")
dataset_humid <- datasettemp$'TRUE'

# Split dataset by Duration
ds <- split(dataset_humid, dataset_humid$study_duration_cat=="short term")
short <- ds$'TRUE'
dm <- split(dataset_humid, dataset_humid$study_duration_cat=="medium term")
medium <- dm$'TRUE'
dl <- split(dataset_humid, dataset_humid$study_duration_cat=="long term")
long <- dl$'TRUE'
...
write_csv(output, "datasets/aridity_depth_duration.csv")
