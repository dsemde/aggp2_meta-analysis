...
text(ifelse(arid$High_Perc > 70, arid$Low_Perc-15, arid$High_Perc+12), arid$ID
     , paste(arid$obs,"/",arid$n_study, sep = ""), cex=0.85, adj=0)
...
text(ifelse(semi$High_Perc > 70, semi$Low_Perc-15, semi$High_Perc+12), semi$ID
     , paste(semi$obs,"/",semi$n_study, sep = ""), cex=0.85, adj=0)
...
text(ifelse(dry$High_Perc > 70, dry$Low_Perc-15, dry$High_Perc+12), dry$ID
     , paste(dry$obs,"/",dry$n_study, sep = ""), cex=0.85, adj=0)
...
text(ifelse(humid$High_Perc > 70, humid$Low_Perc-15, humid$High_Perc+20), humid$ID
     , paste(humid$obs,"/",humid$n_study, sep = ""), cex=0.85, adj=0)
