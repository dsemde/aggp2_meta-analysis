---
title: "OC by Study Duration and Depth"
output:
  html_document:
    df_print: paged
---
...
```{r}
ggplot(d10, aes(x=study_duration, y=OC_change_rate)) + geom_point() + geom_smooth(method=lm)
```
...
```{r}
ggplot(d20, aes(x=study_duration, y=OC_change_rate)) + geom_point() + geom_smooth(method=lm)
```
...
```{r}
ggplot(d30, aes(x=study_duration, y=OC_change_rate)) + geom_point() + geom_smooth(method=lm)
```
...
```{r}
ggplot(d30p, aes(x=study_duration, y=OC_change_rate)) + geom_point() + geom_smooth(method=lm)
```
...
```{r}
ggplot(d10, aes(x=study_duration, y=per_OC_change)) + geom_point() + geom_smooth(method=lm)
```
...
```{r}
ggplot(d20, aes(x=study_duration, y=per_OC_change)) + geom_point() + geom_smooth(method=lm)
```
...
```{r}
ggplot(d30, aes(x=study_duration, y=per_OC_change)) + geom_point() + geom_smooth(method=lm)
```
...
```{r}
ggplot(d30p, aes(x=study_duration, y=per_OC_change)) + geom_point() + geom_smooth(method=lm)
```
