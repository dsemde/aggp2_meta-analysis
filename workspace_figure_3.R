...
output <- c("14", "Aridity", "Arid", "0 - 10 cm", mean, se, low, high, "orange", obs, n_study)
...
add_row <- c("13", "Aridity", "Semi-arid", "0 - 10 cm", mean, se, low, high, "orange", obs, n_study)
...
add_row <- c("12", "Aridity", "Dry sub-humid", "0 - 10 cm", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
add_row <- c("11", "Aridity", "Humid", "0 - 10 cm", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
# All 0 - 10 cm
mean <- check_NaN(w.mean(dataset_10$per_OC_st_change,dataset_10$organic_C_n_t1))
se <- check_se(w.sd(dataset_10$per_OC_st_change,dataset_10$organic_C_n_t1)/sqrt(sum(dataset_10$organic_C_n_t1)))
low <- mean-se
high <- mean+se
obs <- sum(dataset_10$organic_C_n_t1)
n_study <- length(dataset_10$organic_C_n_t1)
add_row <- c("1", "", "Increment Mean", "0 - 10 cm", mean, se, low, high, "black", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(arid$organic_C_n_t1)
n_study <- length(arid$organic_C_n_t1)
add_row <- c("14", "Aridity", "Arid", "10 - 20 cm", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(semi$organic_C_n_t1)
n_study <- length(semi$organic_C_n_t1)
add_row <- c("13", "Aridity", "Semi-arid", "10 - 20 cm", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(subhumid$organic_C_n_t1)
n_study <- length(subhumid$organic_C_n_t1)
add_row <- c("12", "Aridity", "Dry sub-humid", "10 - 20 cm", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(humid$organic_C_n_t1)
n_study <- length(humid$organic_C_n_t1)
add_row <- c("11", "Aridity", "Humid", "10 - 20 cm", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
# All 10 - 20 cm
mean <- check_NaN(w.mean(dataset_20$per_OC_st_change,dataset_20$organic_C_n_t1))
se <- check_se(w.sd(dataset_20$per_OC_st_change,dataset_20$organic_C_n_t1)/sqrt(sum(dataset_20$organic_C_n_t1)))
low <- mean-se
high <- mean+se
obs <- sum(dataset_20$organic_C_n_t1)
n_study <- length(dataset_20$organic_C_n_t1)
add_row <- c("1", "", "Increment Mean", "10 - 20 cm", mean, se, low, high, "black", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(arid$organic_C_n_t1)
n_study <- length(arid$organic_C_n_t1)
add_row <- c("14", "Aridity", "Arid", "20 - 30 cm", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(semi$organic_C_n_t1)
n_study <- length(semi$organic_C_n_t1)
add_row <- c("13", "Aridity", "Semi-arid", "20 - 30 cm", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(subhumid$organic_C_n_t1)
n_study <- length(subhumid$organic_C_n_t1)
add_row <- c("12", "Aridity", "Dry sub-humid", "20 - 30 cm", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(humid$organic_C_n_t1)
n_study <- length(humid$organic_C_n_t1)
add_row <- c("11", "Aridity", "Humid", "20 - 30 cm", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
# All 20 - 30 cm
mean <- check_NaN(w.mean(dataset_30$per_OC_st_change,dataset_30$organic_C_n_t1))
se <- check_se(w.sd(dataset_30$per_OC_st_change,dataset_30$organic_C_n_t1)/sqrt(sum(dataset_30$organic_C_n_t1)))
low <- mean-se
high <- mean+se
obs <- sum(dataset_30$organic_C_n_t1)
n_study <- length(dataset_30$organic_C_n_t1)
add_row <- c("1", "", "Increment Mean", "20 - 30 cm", mean, se, low, high, "black", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(arid$organic_C_n_t1)
n_study <- length(arid$organic_C_n_t1)
add_row <- c("14", "Aridity", "Arid", "30+ cm", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(semi$organic_C_n_t1)
n_study <- length(semi$organic_C_n_t1)
add_row <- c("13", "Aridity", "Semi-arid", "30+ cm", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(subhumid$organic_C_n_t1)
n_study <- length(subhumid$organic_C_n_t1)
add_row <- c("12", "Aridity", "Dry sub-humid", "30+ cm", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
obs <- sum(humid$organic_C_n_t1)
n_study <- length(humid$organic_C_n_t1)
add_row <- c("11", "Aridity", "Humid", "30+ cm", mean, se, low, high, "orange", obs, n_study)
output <- rbind(output, add_row)
...
# All 20 - 30 cm
mean <- check_NaN(w.mean(dataset_30p$per_OC_st_change,dataset_30p$organic_C_n_t1))
se <- check_se(w.sd(dataset_30p$per_OC_st_change,dataset_30p$organic_C_n_t1)/sqrt(sum(dataset_30p$organic_C_n_t1)))
low <- mean-se
high <- mean+se
obs <- sum(dataset_30p$organic_C_n_t1)
n_study <- length(dataset_30p$organic_C_n_t1)
...
# mean <- check_NaN(w.mean(dataset$per_OC_st_change,dataset$organic_C_n_t1))
# se <- check_se(w.sd(dataset$per_OC_st_change,dataset$organic_C_n_t1)/sqrt(sum(dataset$organic_C_n_t1)))
# low <- mean-se
# high <- mean+se
# obs <- sum(dataset$organic_C_n_t1)
# n_study <- length(dataset$organic_C_n_t1)
...
write_csv(output, "datasets/aridity_texture_irrigation_depth.csv")
