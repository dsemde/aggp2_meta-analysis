...
sum_data <- read.csv("datasets/aridity_texture_irrigation_depth.csv")

d <- sum_data %>% group_split(treatment)
...
tiff("Figure 3 - OC Stock Full aug 31.tiff", width = 12, height = 4, units = 'in', res = 300)
...
text(ifelse(d10$High_Perc > 50, d10$Low_Perc-10, d10$High_Perc+3), d10$ID
     , paste(d10$n_study), cex=0.85, adj=0)
...
text(ifelse(d20$High_Perc > 65, d20$Low_Perc-10, d20$High_Perc+3), d20$ID
     , paste(d20$n_study), cex=0.85, adj=0)
...
# sort(sum_data$High2_Perc)
text(ifelse(d30$High_Perc > 62, d30$Low_Perc-10, d30$High_Perc+3), d30$ID
     , paste(d30$n_study), cex=0.85, adj=0)
...
# sort(sum_data$High2_Perc)
text(ifelse(d30p$High_Perc > 62, d30p$Low_Perc-10, d30p$High_Perc+3), d30p$ID
     , paste(d30p$n_study), cex=0.85, adj=0)
